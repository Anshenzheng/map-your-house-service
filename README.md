...
前端源码: [https://github.com/night-233/map-your-house-admin](https://github.com/night-233/map-your-house-admin)

项目致力于打造一个完整的租房系统，采用现阶段流行技术实现。

## **项目介绍**
map-your-house 项目是一套模仿自如的租房系统，基于SpringBoot+Elasticsearch实现，采用Docker容器化部署。系统主要包含租房首页、房源搜索、房源展示、地图找房、房源周边检索、收藏栏、看房预约、用户中心、发布管理、账号管理等模块。

## 在线演示

租房网地址:  [http://house.annan.top](http://house.annan.top)  账号: 17811111111 密码: 123

后端swiger接口地址:  [http://house.frp.annan.top/swagger-ui.html](http://house.frp.annan.top/swagger-ui.html)  账号: admin 密码: 123
...
1. clone前端源码([前端源码]([https://github.com/night-233/map-your-house-admin](https://github.com/night-233/map-your-house-admin)))
2. 执行 yarn install
3. 执行 yarn start 

项目启动后默认打开: [localhost:3000](localhost:3000) 端口。 后端接口默认连接的是我个人服务器(可能有点慢)，如果使用了上面的Docker部署了开发环境，可在config-override.js中修改IP的地址为本地。

默认接口文档地址:  [http://map-your-house.annan.top](http://map-your-house.annan.top) 

#### 项目二次开发

对于需要进行二次开发的同学，可以搭建一套自己的开发环境，相关数据表及索引如下

数据库表:  map-your-house/src/main/resources/db/map-your-house.sql  

elasticsearch索引:  map-your-house/src/main/resources/db/house_index__ik_mapping_suggestion.json   (elastic需要安装ik分词器)
...
## <img src="http://qiniu.annan.top/qrcode.jpg" alt="qrcode"  width="200" height="200"/>
...
## ![用户首页](http://qiniu.annan.top/client-filter.jpg)



![image-20200707162953900](http://qiniu.annan.top/image-20200707162953900.png)

![image-20200707163051367](http://qiniu.annan.top/image-20200707163051367.png)



![image-20200707163359418](http://qiniu.annan.top/image-20200707163359418.png)

![user-center](http://qiniu.annan.top/user-center.jpg)

 ![login-page](http://qiniu.annan.top/login-page.png)


![forget-password](http://qiniu.annan.top/forget-password.jpg)
